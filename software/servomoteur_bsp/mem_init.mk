...
# Memory: Onchip_SRAM
MEM_0 := Computer_System_Onchip_SRAM
$(MEM_0)_NAME := Onchip_SRAM
...
.PHONY: Onchip_SRAM
Onchip_SRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

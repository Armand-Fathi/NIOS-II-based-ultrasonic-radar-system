	Computer_System u0 (
		...
		.conduit_echo               (<connected-to-conduit_echo>),               //              conduit.echo
		.conduit_dist               (<connected-to-conduit_dist>),               //                     .dist
		.conduit_trig               (<connected-to-conduit_trig>),               //                     .trig
		.conduitsm_commande         (<connected-to-conduitsm_commande>),         //            conduitsm.commande
